...
print ("Exp 1")
constituent_name = ("4-Methylmorpholine N-oxide"), ("potassium osmate dihydrate"), ("(5R,7aS)‐5‐butyl‐1H,3H,5H,7aH‐pyrrolo[1,2‐c][1,3]oxazol‐3‐one mmol")
constituent_mass = (1.76), (97.3), (347)
...
constituent_conc = (0.01), (0.5), (0.5), (0)
print (type_one)
print ("names",(constituent_name))
print (str(constituent_mass) + ", mass shown respectively")
print (str(constituent_conc) + ", concentration shown respectively")
...
print ("Exp 3")
constituent_name = "(1S,2S)-1,2-Bis(2-hydroxyphenyl)-1,2-diaminoethane ", "2-methylbenzaldehyde "
constituent_mass = (1.00), (1.23)
constituent_conc = (4.1), (10.2)
constituent_eqs = (1.0), (2.5)
print (type_one)
print ("names",(constituent_name))
print (str(constituent_mass) + ", mass shown respectively")
print (str(constituent_conc) + ", concentration shown respectively")
...
print ("Exp 4")
constituent_name = "benzylamine", "2-methylbenzaldehyde"
constituent_mass = (0), (0)
constituent_conc = (1), (1)
print (type_one)
print ("names",(constituent_name))
print (str(constituent_mass) + ", mass shown respectively")
print (str(constituent_conc) + ", concentration shown respectively")
...
constituent_mass = (0.700), (0.276), (0.287)
...
print (str(constituent_conc) + ", concentration shown respectively")
print ("Exp 9")
constituent_name = "1,3-bis(2,6-di-iso-propylphenyl)-4,5-dimenthylimidzolium chloride", "potassium tert-butoxide", "[Ir(COD)Cl]2"
constituent_mass = (0.340), (0.101), (0)
constituent_conc = (0.750), (0.900), (0)
print (type_two)
print ("names",(constituent_name))
print (str(constituent_mass) + ", mass shown respectively")
print (str(constituent_conc) + ", concentration shown respectively")
...
constituent_mass = (189), (0)
constituent_conc = (0.500), (0.00325)
constituent_eqs = (1.00), (0)
print (type_one)
print ("names",(constituent_name))
print (str(constituent_mass) + ", mass shown respectively")
print (str(constituent_conc) + ", concentration shown respectively")
...
constituent_mass = (2.12), (7.40), (19)
constituent_conc = (52.9), (132), (44.1)
constituent_eqs = (1.20), (3.00), (1.00)
print (type_two)
print ("names",(constituent_name))
print (str(constituent_mass) + ", mass shown respectively")
print (str(constituent_conc) + ", concentration shown respectively")
